    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="fairuzAdmin.html">A D M I N</a>
            </div>

            <div class="header-right">   
                <meta name="viewport" content="width=device-width, initial-scale=1">
                <a href="#" class="btn btn-warning" title="Pengaturan"><b>  </b><i class="fa fa-gear fa-2x"></i></a>
                <a href="#" class="btn btn-info" title="Pesan Baru"><b>  </b><i class="fa fa-envelope fa-2x"></i></a>
                <a href="#" class="btn btn-primary" title="Task Baru"><b>  </b><i class="fa fa-bars fa-2x"></i></a>
                    ...
                    <li>
                        <li>
                            ...
                            <a href="fairuzAdmin.html"><i class="fas fa-file-invoice"></i> LAPORAN <span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level">
                                 <li>
                                    <a href="fairuzAdminbaru.php"><i class="fa fa-desktop "></i> Hasil Seleksi </span> </a>
                                </li>
                                <li>
